...
export const surveySections: SurveySection[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { id: "A4", label: "What is your main occupation?", type: "radio", required: true, options: [{ label: "Student [1]", value: "1" }, { label: "Service [2]", value: "2" }, { label: "Business [3]", value: "3" }, { label: "Unemployed [4]", value: "4" }, { label: "Other [5]", value: "5" }, { label: "Job [6]", value: "6" }, { label: "Labour [7]", value: "7" }, { label: "Agriculture [8]", value: "8" }] },
